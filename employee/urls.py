...
urlpatterns = [
    ...
    path('employeeinsert/', views.employee_insert, name='employee_insert'),
    path('employeeoutput/', views.employeeoutput, name='employeeoutput'),
    path('employeeview/<int:id>', views.employeeview, name='employee_view'),
    path('employeelist/', views.employeelist, name='employee_list'),
    path('employeeedit/<int:id>', views.employee_edit, name='employee_edit'),
    path('employeeviewupdate/', views.employeeview_update, name='employeeview_update'),
