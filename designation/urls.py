...
urlpatterns = [
    ...
    path('designation/', views.designationpage, name='designationpage'),
    path('designationinsert/', views.designation_insert, name='designation_insert'),
    path('designationoutput/', views.designationoutput, name='designationoutput'),
